package tech.reliab.course.bahtinva;

import tech.reliab.course.bahtinva.bank.entity.*;
import tech.reliab.course.bahtinva.bank.service.*;
import tech.reliab.course.bahtinva.bank.service.impl.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        //создаем клиента
        User user = userService.create("Vlad", "Bahtin", LocalDate.now(),"job",bank);
